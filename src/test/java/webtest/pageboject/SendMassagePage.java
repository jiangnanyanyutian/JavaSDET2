...
public class SendMassagePage extends CommonPage {
    ...
    public SendMassagePage sendmessage(String menber) throws InterruptedException {
        Thread.sleep(2000);
    ...
    public SendMassagePage sendcontent(String title, String content, String addtionURL, String picture, String summary, String author) throws InterruptedException {
     ...
     //确定发送消息
    public SendMassagePage confirmsend() {
